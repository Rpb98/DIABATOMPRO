...
read_file("./tests/SO_test.inp") # ../Supplementary/SO/SO_C_Cp_DMZ.inp ./TEST_input.inp"/Users/ryanbrady/Documents/PhD/Work/DIABATISATION/DIABATOM_PRO_PACKAGE/github_dev/DIABATOMPRO/Supplementary/SO/SO_B.inp") ##../Supplementary/SO/SO_B.inp
...
if haskey(Calculation, "vibronic_solver")
    ...
    #
    plot_vibronic_solution(r, PotMat, [1,2], E_vib_contr,  contr_vib_wfn, [Calculation["vibronic_solver"].contraction[1],Calculation["vibronic_solver"].contraction[2]])
end
